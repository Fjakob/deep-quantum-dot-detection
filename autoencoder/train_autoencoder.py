...
Automatically generated by Colaboratory for git saving.
...
class decoder2(nn.Module):
    ...
    def __init__(self, latent_dim):
        ...
        self.conv2T   = nn.ConvTranspose1d(64, 32, 6, stride=3)
        self.conv3T   = nn.ConvTranspose1d(32, 16, 6, stride=3)
        self.conv4T   = nn.ConvTranspose1d(16, 4, 5, padding=2)
        self.conv5T   = nn.ConvTranspose1d(4, 1, 5)
        self.bn1 = nn.BatchNorm1d(128)
        self.bn2 = nn.BatchNorm1d(64)
        self.bn3 = nn.BatchNorm1d(32)
        self.bn4 = nn.BatchNorm1d(16)
...
for epoch in range(epochs):
    ...
    for batch_original in train_loader:
        ...
        train_loss = loss(batch_original, batch_decoded)
    ...
    with torch.no_grad():
        ...
        for test_batch in test_loader:
            ...
            test_loss += loss(test_batch, test_batch_decoded).item()
